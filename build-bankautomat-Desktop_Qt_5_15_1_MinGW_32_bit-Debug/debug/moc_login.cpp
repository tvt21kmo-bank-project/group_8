...
QT_MOC_LITERAL(1, 6, 14), // "korttiEiNatsaa"
...
void login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->korttiEiNatsaa(); break;
        ...
        {
            using _t = void (login::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&login::korttiEiNatsaa)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&login::korttiAutuaammilleAutomaateille)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (login::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&login::korttiOk)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (login::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&login::loginOk)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void login::korttiEiNatsaa()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void login::korttiAutuaammilleAutomaateille(int _t1)
{
